...
class ColdDeliveryState(str, Enum):
    CREATED = "CREATED"; READY = "READY"; T3_BLOCKED = "T3_BLOCKED"; DISPATCH_PLANNED = "DISPATCH_PLANNED"; DISPATCHING = "DISPATCHING"; ACCEPTED = "ACCEPTED"; REJECTED = "REJECTED"; TECHNICAL_RETRY_DUE = "TECHNICAL_RETRY_DUE"; RECONCILIATION_REQUIRED = "RECONCILIATION_REQUIRED"; UNRESOLVED_TERMINAL = "UNRESOLVED_TERMINAL"
...
_TRANSITIONS = {
    ...
    ColdDeliveryState.DISPATCH_PLANNED: {ColdDeliveryState.DISPATCHING, ColdDeliveryState.TECHNICAL_RETRY_DUE, ColdDeliveryState.RECONCILIATION_REQUIRED, ColdDeliveryState.UNRESOLVED_TERMINAL},
